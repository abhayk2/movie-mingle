...
export const Header = () => {
  ...
  return (
    <header>      
    <nav className="dark:bg-gray-900 bg-white border-b-2 border-gray-200  px-2 sm:px-4 py-2 dark:border-b-2  dark:border-gray-900" >
      <div className="flex flex-wrap justify-between items-center mx-auto">
      <Link to="/" className="flex items-center">
          <img src={Logo} className="mr-2 h-12 sm:h-9 w-10" alt="MovieMingle Logo" />
          <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">MovieMingle</span>
      </Link>
