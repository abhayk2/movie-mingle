...
export const MovieDetail = () => {
  ...
  useEffect(()=>{
    async function fetchMovie(){
      const response= await fetch(`https://api.themoviedb.org/3/movie/${param.id}?api_key=0c9d7965f355fe5aeaf1de484d13b829`);
        ...
        <div className="max-w-2xl text-gray-700 text-lg dark:text-white">
            ...
            {movie.genres? (
              ...
              <div className="flex items-center">
                  ...
                  <p className="ml-2 text-gray-900 dark:text-white">{parseFloat(movie.vote_average).toFixed(2)}</p>
                  ...
                  <p className="my-4">
                    ...
                    <span>{Math.floor(movie.budget/1000000)} M</span>
                  </p>
                  <p className="my-4">
                    <span className="mr-2 font-bold">Revenue:</span>
                    <span>{Math.floor(movie.revenue/1000000)} M</span>
                  </p>
                  <p className="my-4">
